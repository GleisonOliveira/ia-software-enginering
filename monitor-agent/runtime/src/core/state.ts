...
/**
 * Creates AgentState objects from loaded contracts and user input.
 *
 * Extracts limits from the regras.md contract, applies CLI overrides for agent
 * type, and initializes all mutable tracking fields to their zero values.
 * Each call returns a fresh object with no shared references.
 *
...
export class StateManager {
  ...
  createState(
    ...
    const limits = this.extractLimits(contracts);
   ...
   */
  private extractLimits(contracts: AllContracts): StateLimits {
